...
void Test1() {
    ...
    cout << "TEST1 DEBUG: Plane1 Added: " << p1->getID() << endl;
    Plane* p2 = myImplementation->addPlane(p1Model, p1crewNeeded, seats);
    cout << "TEST1 DEBUG: Plane2 Added: " << p2->getID() << endl;
    ...
    cout << "TEST1 DEBUG: Customer1 Added: " << c1->getID() << endl;
    // ---- END CUSTOMER 1 ----
    // ---- CUSTOMER 2 ----
    ...
    cout << "TEST1 DEBUG: Customer2 Added: " << c2->getID() << endl;
    // ---- END CUSTOMER 2 ----
    // ---- CUSTOMER 3 ----
    ...
    cout << "TEST1 DEBUG: Customer3 Added: " << c3->getID() << endl;
    // ---- END CUSTOMER 3 ----
    // ---- CUSTOMER 4 ----
    fullName = "David Vita";
    priority = 4;
    ...
    cout << "TEST1 DEBUG: Customer4 Added: " << c4->getID() <<endl;
    // ---- END CUSTOMER 4 ----
    ...
    cout << "TEST1 DEBUG: Employee1 Added: " << emp1->getID() << endl;
    // ---- EMPLOYEE 1 ----
    ...
    cout << "TEST1 DEBUG: Employee2 Added: " << emp2->getID() << endl;
    // ---- EMPLOYEE 2 ----
    ...
    cout << "TEST1 DEBUG: Employee3 Added: " << emp3->getID() << endl;
    // ---- EMPLOYEE 3 ----
    ...
    cout << "TEST1 DEBUG: Employee4 Added: " << emp4->getID() << endl;
    // ---- EMPLOYEE 4 ----
    ...
    if(d == d1) cout << "TEST1 DEBUG: DATE TEST 1 PASSED" << endl;
    if(d > d2) cout << "TEST1 DEBUG: DATE TEST 2 PASSED" << endl;
    if(d < d3) cout << "TEST1 DEBUG: DATE TEST 3 PASSED" << endl;
    if(d < d4) cout << "TEST1 DEBUG: DATE TEST 4 PASSED" << endl;

    // ---- END TEST DATES ----

    Flight* f1 = myImplementation->addFlight(747, d, "israel", "metula");
    cout << "TEST1 DEBUG: Flight Added: " << f1->getID() << endl;
    ...
    cout << "TEST1 DEBUG: Employee4 Added: " << emp5->getID() << endl;
    // ---- EMPLOYEE 5 ----
    ...
    cout << "TEST1 DEBUG: Employee4 Added: " << emp6->getID() << endl;
    // ---- EMPLOYEE 6 ----
    ...
    cout << "TEST1 DEBUG: Employee4 Added: " << emp7->getID() << endl;
    // ---- EMPLOYEE 7 ----
    ...
    cout << "TEST1 DEBUG: Employee4 Added: " << emp8->getID() << endl;
    // ---- EMPLOYEE 8 ----
    ...
    cout << "TEST1 DEBUG: Employee1 Added: " << emp9->getID() << endl;
    // ---- EMPLOYEE 9 ----

    Flight* f2 = myImplementation->addFlight(747, d, "israel", "metula");
    cout << "TEST1 DEBUG: Flight Added: " << f2->getID() << endl;
